...
class Vector:
    ...
    def direction(self):
        ...
        if (self.__complex_vector.imag == 0.0):
            ...
            if (self.__complex_vector.real >= 0.0): return cmath.pi/2.0 - self.__phase;
            else: return 2 * cmath.pi + cmath.pi/2.0 - self.__phase;
        else: return cmath.pi/2.0 - self.__phase;
        # if (self.__complex_vector.imag == 0.0):
        #     if (self.__complex_vector.real > 0.0): return cmath.pi/2.0;
        #     elif (self.__complex_vector.real == 0.0): return 0.0;
        #     else: return cmath.pi + cmath.pi / 2.0;
